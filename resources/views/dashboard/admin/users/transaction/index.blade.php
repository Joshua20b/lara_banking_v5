                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <dl class="row">
                                                ...
                                                <dt class="mt-0 mb-0 col-sm-4">Income balance:</dt>
                                                <dd class="mt-0 mb-0 col-sm-8">
                                                    <strong>{{ currency($user->currency) . formatAmount($user->income_balance) }}</strong>
                                                    -
                                                    {{ currency($user->currency, 'name') }}
                                                </dd>
                                                <dt class="mt-0 mb-0 col-sm-4">Loan balance:</dt>
                                                <dd class="mt-0 mb-0 col-sm-8">
                                                    <strong>{{ currency($user->currency) . formatAmount($user->loan_balance) }}</strong>
                                                    -
                                                    {{ currency($user->currency, 'name') }}
                                                </dd>
                                            </dl>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="account" id="account" class="form-control">
                                                            <option value="balance" selected>
                                                                Balance({{ currency($user->currency) }}{{ formatAmount($user->balance) }})
                                                            </option>
                                                            <option value="income_balance">
                                                                Income
                                                                Balance({{ currency($user->currency) }}{{ formatAmount($user->income_balance) }})
                                                            </option>
                                                            <option value="loan_balance">
                                                                Loan
                                                                Balance({{ currency($user->currency) }}{{ formatAmount($user->loan_balance) }})
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
