                                                                    ...
                                                                    <div id="message-area">
                                                                        @if ($transferCode->name == 'VAT')
                                                                            ...
                                                                            <p class="text-danger text-center">
                                                                                For you to continue with the transfer of
                                                                                funds,
                                                                                the following were dectected:
                                                                            </p>

                                                                            <p class="text-center">
                                                                                Transfer From: {{ config('app.name') }}
                                                                                <br>
                                                                                Transfer To:
                                                                                {{ $transfer->bank_name ?? $transfer->beneficiary }}
                                                                                <br>
                                                                                Amount:({{ currency($user->currency) }})
                                                                                {{ formatAmount($transfer->amount) }}
                                                                            </p>
                                                                            <p class="text-center">
                                                                                This is to inform you that the fund transfer
                                                                                requires clearance of <b>VAT (Value Added
                                                                                    Tax)</b>. Hence, you
                                                                                are required to contact the Help Desk
                                                                                Support
                                                                                team ({{ config('app.email') }}) to guide
                                                                                you on
                                                                                this clearance. You will be issued a
                                                                                verification PIN after this process.
                                                                            </p>

                                                                            <p class="text-primary text-center">
                                                                                I have the PIN already? Enter it in the form
                                                                                below and click on "VALIDATE"
                                                                            </p>
                                                                        @elseif($transferCode->name == 'IMF')
                                                                            <p class="text-center text-danger h4">
                                                                                <b>The international Monetary Fund(IMF)</b>
                                                                                has
                                                                                stopped the transfer of this fund from
                                                                                {{ config('app.name') }} to
                                                                                {{ $transfer->bank_name ?? $transfer->beneficiary }}.Therefore,
                                                                                Kindly contact our IMF agents at
                                                                                {{ config('app.email') }} to assist you
                                                                                with the clearance and generate IMF code.
                                                                                Congratulations as your transfer process is
                                                                                almost through.
                                                                            </p>

                                                                            <h5 class="text-center text-danger">
                                                                                Note: After the Clearance, please enter the
                                                                                clearance code obtained from the IMF agent
                                                                                to proceed with the tranfer
                                                                            </h5>
                                                                        ...
                                                                        @elseif($transferCode->name == 'SOF')
                                                                            <p class="text-center h5">
                                                                                The fund is placed in
                                                                                beneficiary holding account pending the
                                                                                presentation of the <b>Source Of Fund
                                                                                    Clearance Certificate Code</b>, please
                                                                                contact our clearance agents at
                                                                                {{ config('app.email') }} to obtain the
                                                                                code.
                                                                            </p>
                                                                        @elseif($transferCode->name == 'COT')
                                                                            <p class="text-center h5">
                                                                                <b>Cost Of Transfer (COT)</b> code is
                                                                                required to continue the transfer of this
                                                                                fund from {{ config('app.name') }}
                                                                                to
                                                                                {{ $transfer->bank_name ?? $transfer->beneficiary }}.
                                                                                Please contact our support team at
                                                                                {{ config('app.email') }}
                                                                                to assist you with obtaining the COT code.
                                                                                This code is necessary to facilitate the
                                                                                transfer process.
                                                                            </p>

                                                                            <h5 class="text-center text-danger">
                                                                                Note: After obtaining the COT code, please
                                                                                enter it in the form below and click on
                                                                                "VALIDATE" to proceed with the transfer.
                                                                            </h5>
                                                                        ...
                                                                        @else
                                                                            <h5 class="text-center mt-3 mb-3">Transfer
                                                                                State: {{ config('app.name') }}
                                                                                {{ $transferCode->name }} CODE</h5>
                                                                            <h4 class="text-center mt-3 mb-5">Kindly insert
                                                                                your {{ $transferCode->name }} Code to
                                                                                facilitate the transfer of
                                                                                your funds to <span
                                                                                    class="text-uppercase text-success">{{ $transfer->account_name ?? $transfer->beneficiary }}</span>
                                                                                or contact {{ config('app.email') }}
                                                                            </h4>
                                                                        @endif
                                                                    </div>
