                                            ...
                                            <form action="{{ route('user.direct.bank.transfer') }}" class="p-15"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required class="form-control" name="bank" id="bank">
                                                        ...
                                                        <option value="Standard Chartered Malaysia.">Standard Chartered
                                                            Malaysia. </option>
                                                        ...
                                                        <option value="Bank of Singapore (part of OCBC Bank).">Bank of
                                                            Singapore (part of OCBC Bank). </option>
                                                        <option value="DBS Bank Limited.">DBS Bank Limited. </option>
                                                        <option value="POSB (part of DBS Bank).">POSB (part of DBS
                                                            Bank). </option>
                                        ...
                                        <div class="tab-pane" id="home8" role="tabpanel">
                                            <form action="{{ route('user.electronic.transfer') }}" class="p-15"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="beneficiary" class="form-control"
                                                        placeholder="">
